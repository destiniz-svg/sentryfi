...
const { PASSON_SQL } = require("./passon-schema");
...
const { RETURNS_SQL } = require("./returns-schema");
const { ITEMS_SQL } = require("./items-schema");
const { RELEASE_SQL } = require("./release-schema");
...
const { COUNTS_SQL } = require("./counts-schema");
const { BATCHES_SQL } = require("./batches-schema");
const { CONTACT_EXTRAS_SQL } = require("./contact-extras-schema");
const { PLATFORM_SQL } = require("./platform-schema");
const { AUDIT_SQL } = require("./audit-schema");
...
const ALL_SQL = [
  ...
  STATEMENT_SQL, PERIOD_SQL, TAX_SQL, IMPORT_SQL, FX_SQL, PEOPLE_SQL, BACKUP_SQL, ASSETS_SQL, LOANS_SQL, DIMENSIONS_SQL, CURRENCY_SQL, ACCESS_SQL, STOCK_SQL, ADVISER_SQL, SHIPMENT_SQL, PROJECTS_SQL, ORDERS_SQL, RECURRING_SQL, CLAIMS_SQL, PASSON_SQL, PORTAL_SQL, CFO_SQL, PUSH_SQL, DOCUMENTS_SQL, FIELD_SQL, KEYS_SQL, NWT_SQL, INCOMETAX_SQL, PLACES_SQL, COUNTS_SQL, BATCHES_SQL, CONTACT_EXTRAS_SQL, PLATFORM_SQL, PAYROLL_SQL, ADVANCES_SQL, SHARE_SQL, COMMENTS_SQL, CONTACTS_SQL, RETURNS_SQL, ITEMS_SQL, RELEASE_SQL, AUDIT_SQL,
