...
This file holds everything from the build plan that is rationale, history, design narrative, review notes, "not doing" decisions and the long "done" write-ups — moved here verbatim so none of it is lost when TODO.md was rebuilt into a short, current plan on 23 September 2026. The live plan is TODO.md; this file is the record of how it got there and why things were decided the way they were. Below is the build plan exactly as it stood before that rewrite.
