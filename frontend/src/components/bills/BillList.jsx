...
import { ListTree, Ban, Loader2, Undo2, MoreHorizontal } from "lucide-react";
...
/**
 * The bill list, one card, each row with its next steps in view. The Bills
 * page and the phone's Money screen both show it, so a bill looks and acts
