...
const TABS = [
  ...
  { to: "/more", icon: LayoutGrid, label: "More", also: ["/settings", "/reports", "/contacts", "/inbox", "/statements", "/closing", "/tax", "/import", "/assets", "/loans", "/stock", "/inventory", "/shipments", "/projects", "/orders", "/claims", "/approvals", "/payments", "/cfo"] },
];
