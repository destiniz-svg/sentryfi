            ...
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                <defs>
                  ...
                  <linearGradient id="gSent" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stopColor="#fff3c2" /><stop offset="100%" stopColor="#f2c300" /></linearGradient>
                  <linearGradient id="gOverdue" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stopColor="#c62b20" /><stop offset="100%" stopColor="#e11d48" /></linearGradient>
                  <linearGradient id="gDraft" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stopColor="#d6d8dd" /><stop offset="100%" stopColor="#6b7078" /></linearGradient>
                </defs>
          ...
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={aging} margin={{ top: 8, right: 4, bottom: 0, left: -14 }}>
              <defs>
                ...
                <linearGradient id="gWarn" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#f2c300" /><stop offset="100%" stopColor="#d97706" /></linearGradient>
                <linearGradient id="gDanger" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#c62b20" /><stop offset="100%" stopColor="#e11d48" /></linearGradient>
              </defs>
              <CartesianGrid strokeDasharray="3 3" stroke="var(--border)" vertical={false} />
