...
23. **An accepted quote drafts its invoice**, and the office is told; a person always sends it (owner's decision). Then **billing a job in parts**, by percentage or milestone, with what is left shown on the quote. *First half done 26 Sep 2026:* accepting a quote, in the office or by the customer's link, drafts its invoice (never posted or sent), tells the people who record, and the sales order shows "Invoiced, to go out" until the goods leave (tools/quote-invoice.js).
