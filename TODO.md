...
26. **Send and arrive**: a transfer is two steps with goods in transit between them, received on a phone, and any shortfall is shown with a reason. **Use on a job**: stock issued to a project or department carries its cost there.
