...
- Promised and coming: goods received on a purchase order but not yet billed are in neither on hand (not in the books until the bill posts) nor on order. Item 35 (what is still owed) should show them as "received, waiting for the bill".
...
35. **What is still owed (backorders)**: the quantity left to deliver on each sales order and left to arrive on each purchase order, shown on the order and in one list; a line can be closed short, with a reason, to stop expecting the rest.
